 ...
 */
export const PatchMenuItemParams = zod.object({
  "id": zod.coerce.number()
})


export const patchMenuItemBodyPriceMin = 0;



export const PatchMenuItemBody = zod.object({
  "categoryId": zod.number().optional(),
  "name": zod.string().min(1).optional(),
  "description": zod.string().optional(),
  "price": zod.number().min(patchMenuItemBodyPriceMin).optional(),
  "imageUrl": zod.string().optional(),
  "available": zod.boolean().optional()
})

export const PatchMenuItemResponse = zod.object({
  "id": zod.number(),
  "categoryId": zod.number(),
  "categoryName": zod.string().nullish(),
  "name": zod.string(),
